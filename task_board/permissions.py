...
class TeamStaffOrOwnerRequiredMixin(UserInTeamProjectRequiredMixin):
    """
    Filter the user based on the team__project primary key.
...
class UserTeamOwnerProjectRequiredMixin(UserTeamOwnerRequiredMixin,
...
class UserTeamOwnerTeamRequiredMixin(UserTeamOwnerRequiredMixin,
