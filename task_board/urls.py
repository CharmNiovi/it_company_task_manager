...
urlpatterns = [
    ...
    path(
        "project/<int:pk>/task/<int:task_pk>/update/",
        TaskUpdateView.as_view(),
        name="task-update"
    ),
    path(
        "project/<int:pk>/task/<int:task_pk>/",
        TaskDetailView.as_view(),
        name="task-detail"
    ),
    path(
        "project/<int:pk>/task/<int:task_pk>/delete/",
    ...
    path(
        "team/<int:pk>/add_user/",
        AddTeamWorkerInTeamView.as_view(),
        name="add-team-worker-in-team"
    ),
    path(
        "team/<int:pk>/change_permission_in_<str:slug>/",
        ChangeTeamWorkerIsStaffPermissionView.as_view(),
